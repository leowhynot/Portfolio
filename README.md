...
| [Классификация комментариев ](https://clc.to/T3Zhpg) | Попробовал 3 способа для решения задачи. Модель на основе эмбедингов Bert показала наилучший результат.  | *bert, catboost, scikit-learn, torch, optuna, lgbm, pandas* |
